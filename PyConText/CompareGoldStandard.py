...
adjudicatedDirectories = ['/users/shah/Box Sync/MIMC_v2/Annotation/Adjudication/batch_0/adjudication/',
                          '/users/shah/Box Sync/MIMC_v2/Annotation/Adjudication/batch_1/adjudication/',
                          '/users/shah/Box Sync/MIMC_v2/Annotation/Adjudication/batch_2/adjudication/',
                          '/users/shah/Box Sync/MIMC_v2/Annotation/Adjudication/batch_3/adjudication/']
...
targets = itemData.instantiateFromCSVtoitemData('/Users/shah/Developer/PythonVirtualEnv/lib/python2.7/site-packages/eHostess/PyConTextInterface/TargetsAndModifiers/targets.tsv')
